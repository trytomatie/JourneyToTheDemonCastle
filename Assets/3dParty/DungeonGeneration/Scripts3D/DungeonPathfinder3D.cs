...
public class DungeonPathfinder3D {
    ...
    public List<Vector3Int> FindPath(Vector3Int start, Vector3Int end, Func<Node, Node,Vector3Int, PathCost> costFunction) {
        ResetNodes();
        queue.Clear();
        closed.Clear();
        ...
        while (queue.Count > 0) {
            ...
            foreach (var offset in neighbors) {
                ...
                var pathCost = costFunction(node, neighbor,end);
