...
namespace MoreMountains.Feedbacks
{
	...
	public class MMF_ParticlesInstantiation : MMF_Feedback
	{
		...
		public enum PositionModes { FeedbackPosition, Transform, WorldPosition, Script, AttachToParent }
		...
		protected override void CustomPlayFeedback(Vector3 position, float feedbacksIntensity = 1.0f)
		{
			...
			if (_instantiatedParticleSystem != null)
			{
				...
				_instantiatedParticleSystem.Stop();
				if(PositionMode == PositionModes.AttachToParent)
				{
                    _instantiatedParticleSystem.transform.parent = InstantiateParticlesPosition;
