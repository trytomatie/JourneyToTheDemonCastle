...
using OccaSoftware.Exposure.Runtime;

namespace OccaSoftware.Exposure.Editor
{
#if UNITY_2022_2_OR_NEWER
    [CustomEditor(typeof(AutoExposure))]
#else
    [VolumeComponentEditor(typeof(AutoExposure))]
#endif
    public class AutoExposureEditor : VolumeComponentEditor
    {
        ...
        {
            PropertyFetcher<AutoExposure> o = new PropertyFetcher<AutoExposure>(serializedObject);
